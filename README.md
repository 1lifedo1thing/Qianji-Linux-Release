<p align="center">
  <img src="assets/qianji-logo.png" alt="钱迹" width="420">
</p>
...
<p align="center">
  ...
  <a href="https://github.com/NeroSong/Qianji-Linux-Release/releases">版本下载</a> ·
  <a href="#安装">安装指南</a> ·
...
| 适用环境 | 推荐安装包 |
| :--- | :--- |
| Ubuntu / Debian | `qianji_va.b.c-xxxx_amd64.deb` |
| Fedora / RPM 系发行版 | `qianji_va.b.c-xxxx_x86_64.rpm` |
| Arch Linux / Omarchy | `qianji_va.b.c-xxxx_x86_64.pkg.tar.zst` |
| 其他兼容的 x86_64 桌面发行版 | `qianji_va.b.c-xxxx_amd64.AppImage` |
...
```bash
sha256sum -c qianji_va.b.c-xxxx_amd64.deb.sha256
```
...
```bash
sudo apt install ./qianji_va.b.c-xxxx_amd64.deb
```
...
```bash
sudo dnf install ./qianji_va.b.c-xxxx_x86_64.rpm
```
...
```bash
sudo pacman -U ./qianji_va.b.c-xxxx_x86_64.pkg.tar.zst
```
...
```bash
chmod +x qianji_va.b.c-xxxx_amd64.AppImage
./qianji_va.b.c-xxxx_amd64.AppImage
```
...
./install-qianji-appimage.sh ./qianji_va.b.c-xxxx_amd64.AppImage
```
